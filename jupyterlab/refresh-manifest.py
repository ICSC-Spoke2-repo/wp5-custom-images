...
while(True):
    ...
    manifest["spec"]["scheduler"]["spec"]["containers"][0]["image"] = "/cvmfs/unpacked.infn.it/harbor.cloud.infn.it/unpacked/jlab:wp5-alma9-highrate-offload-v0.0.2" 
    manifest["spec"]["worker"]["spec"]["containers"][0]["image"] = "/cvmfs/unpacked.infn.it/harbor.cloud.infn.it/unpacked/jlab:wp5-alma9-highrate-offload-v0.0.2" 
